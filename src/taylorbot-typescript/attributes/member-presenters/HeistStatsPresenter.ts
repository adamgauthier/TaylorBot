...
export class HeistStatsPresenter extends SimpleStatPresenter {
    present(commandContext: CommandMessageContext, member: GuildMember, { heist_win_count, rank, heist_lose_count, heist_win_amount, heist_lose_amount }: Record<string, any> & { rank: string }): EmbedBuilder {
