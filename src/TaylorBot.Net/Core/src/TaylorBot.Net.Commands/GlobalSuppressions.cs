...
[assembly: SuppressMessage("Usage", "CA2227:Collection properties should be read only", Justification = "IOptions<> doesn't work with records", Scope = "member", Target = "~P:TaylorBot.Net.Commands.Options.CommandApplicationOptions.DailyLimits")]
