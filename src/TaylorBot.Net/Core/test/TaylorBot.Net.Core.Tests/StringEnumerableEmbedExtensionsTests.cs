...
namespace TaylorBot.Net.Commands.Types.Tests
{
    ...
    {
        [Fact]
        public void CreateEmbedDescriptionWithMaxAmountOfLines_WhenFirst3LinesHave2046Length_ThenReturnsJoinedFirst3Lines()
        {
            var line1 = CreateLine('1', 682);
            var line2 = CreateLine('2', 682);
            var line3 = CreateLine('3', 682);
