...
namespace TaylorBot.Net.Commands.Discord.Program.Tests
{
    public class WeatherCommandTests
    {
        ...
        {
            _weatherCommand = new WeatherCommand(CommandUtils.UnlimitedRateLimiter, _locationRepository, _locationClient, _weatherClient);
        }
        ...
        public async Task Weather_ThenReturnsEmbedWithTemperature()
        {
            ...
            A.CallTo(() => _locationRepository.GetLocationAsync(_commandUser)).Returns(location);
