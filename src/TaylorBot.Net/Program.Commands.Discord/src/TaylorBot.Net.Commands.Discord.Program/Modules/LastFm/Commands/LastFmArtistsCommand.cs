...
{
    public static readonly CommandMetadata Metadata = new("lastfm artists", "Last.fm 🎶", ["fm artists", "np artists"]);

    public Command Artists(LastFmPeriod? period, DiscordUser user, bool isLegacyCommand) => new(
        Metadata,
        async () =>
        {
