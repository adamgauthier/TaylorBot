...
namespace TaylorBot.Net.PatreonSync.Infrastructure
{
    ...
    {
        private static readonly string GetPatronsQueryString = QueryString.Create(new[] {
            new KeyValuePair<string, string>("include", "user"),
            new KeyValuePair<string, string>("fields[member]", "email,full_name,last_charge_date,last_charge_status,lifetime_support_cents,currently_entitled_amount_cents,patron_status"),
            new KeyValuePair<string, string>("fields[user]", "social_connections"),
        }).ToUriComponent();
