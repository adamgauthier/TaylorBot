...
using (var reader = new StreamReader(@"D:\Projects\TaylorBot\TaylorBot\src\valentines2023-graph\valentines2023.csv"))
using (var csv = new CsvReader(reader, CultureInfo.InvariantCulture))
{
    ...
    var maxChain = chains.MaxBy(c => c.Count);
    Console.WriteLine(maxChain.Count);
}
