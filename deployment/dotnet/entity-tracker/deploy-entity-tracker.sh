...
container_name=$(cat "${__dir}/entity-tracker.name")
image_name=${container_name}
network_name=$(cat "${__dir}/../../docker-network.name")
env_file_path=${__dir}/../taylorbot.net.env
taylorbot_net_path=${__dir}/../../../src/TaylorBot.Net/src
build_context_path=${taylorbot_net_path}
docker_file_path=${taylorbot_net_path}/TaylorBot.Net.EntityTracker.Program/Dockerfile
