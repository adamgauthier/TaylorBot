...
container_name=$(cat "${__dir}/user-notifier.name")
image_name=${container_name}
network_name=$(cat "${__dir}/../../docker-network.name")
env_file_path=${__dir}/user-notifier.env
taylorbot_net_path=${__dir}/../../../src/TaylorBot.Net
build_context_path=${taylorbot_net_path}
docker_file_path=${taylorbot_net_path}/Program.UserNotifier/src/TaylorBot.Net.UserNotifier.Program/Dockerfile
