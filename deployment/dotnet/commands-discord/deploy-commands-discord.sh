...
container_name=$(cat "${__dir}/commands-discord.name")
...
docker_file_path=${taylorbot_net_path}/Program.Commands.Discord/src/TaylorBot.Net.Commands.Discord.Program/Dockerfile
