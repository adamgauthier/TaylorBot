...
container_name=$(cat "${__dir}/post-notifier.name")
image_name=${container_name}
network_name=$(cat "${__dir}/../../docker-network.name")
env_file_path=${__dir}/post-notifier.env
taylorbot_net_path=${__dir}/../../../src/TaylorBot.Net
build_context_path=${taylorbot_net_path}
docker_file_path=${taylorbot_net_path}/Program.PostNotifier/src/TaylorBot.Net.PostNotifier.Program/Dockerfile
